...
dirPasta = '/home/ia/Desktop/P6_1/Esp32cam_Raspberry/Fotos'
...
LBPH = cv2.face.LBPHFaceRecognizer_create(radius = 2,grid_x = 10,grid_y = 10)

LBPH.train(faces, np.array(ids))
LBPH.write('/home/ia/Desktop/P6_1/Esp32cam_Raspberry/ClassRASP_LBPH.yml')
